...
class FileOperations
{
	...
	public function rename(string $newName, string $newExtension = null)
	{
	 ...
	 */
	public function move(string $target, bool $overwrite = false)
	{
	 ...
	 */
	public function copy(string $target, bool $overwrite = false)
	{
