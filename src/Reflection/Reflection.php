...
class Reflection
{
     ...
     * @param int|null      $depth - check also parents traits, 0 all teh way to to last parent
     ...
     * @return bool
     */
    public static function classHasTrait(string|object $objectOrClass, string|object $findObjectOrClass, bool $checkParents = true)
    {
