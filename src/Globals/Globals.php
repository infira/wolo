 ...
 * @method static mixed once(mixed ...$keys, callable $callback) Execute $callback once, if $keys is not provided then cache ID will be generated using callable footprint
