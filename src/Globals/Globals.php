 ...
 * @method static mixed once(callable $callback, mixed ...$keys) Execute $callback once, if $keys is not provided then cache ID will be generated using callable footprint
...
debug(Globals::of('myCollection')->get);